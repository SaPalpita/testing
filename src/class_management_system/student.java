...
public class student extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Colombo", "Gampaha", "Galle", "Mathara", "Kandy", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String brn=(String) jComboBox1.getSelectedItem();
           ...
           DB.iud("insert into student values('"+sid+"','"+fname+"','"+lname+"','"+nicn+"','"+addr+"','"+tp+"','"+brn+"')");
    ...
    ResultSet rs=DB.search("select * from student where id='"+sid+"'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       if(rs.next()){
       DB.iud("update student set fname='"+fname+"',lname='"+lname+"',nic='"+nicn+"',address='"+addr+"',tp='"+tp+"',branch='"+brn+"' where id='"+sid+"'");
       JOptionPane.showMessageDialog(this, "Data has Updated");
       }
       
       else{ 
       JOptionPane.showMessageDialog(this, "Invalied Student ID");}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            DB.iud("DELETE from student where id='"+sid+"'");
            JOptionPane.showMessageDialog(this, "Data has Deleted");
